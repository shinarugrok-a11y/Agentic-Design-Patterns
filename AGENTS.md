...
## Role -> Skills
- planner: routing, planning, multi-agent, goal-setting, resource-optimization, prioritization, inter-agent-a2a, exploration-discovery
- executor: prompt-chaining, routing, parallelization, tool-use, multi-agent, mcp, inter-agent-a2a
- critic: reflection, learning-adaptation, reasoning-techniques, evaluation-monitoring, exploration-discovery
- memory: memory-management, learning-adaptation, mcp, knowledge-retrieval
