...
## Role -> Skills
- planner: routing, planning, multi-agent, goal-setting, resource-optimization, prioritization, a2a, exploration-discovery
- executor: prompt-chaining, routing, parallelization, tool-use, multi-agent, mcp, a2a
- critic: reflection, reasoning-techniques, evaluation-monitoring, learning-adaptation, exploration-discovery
